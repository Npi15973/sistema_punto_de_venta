function obtenerComprobanteFirmado_sri() {
   var  ruta_certificado="public/certificados/oscar_enrique_diaz_capa.p12";
   var  pwd_p12 ="Colmena1587" ;
   var  ruta_factura ="public/comprobantes_electronicos/generados/1905202001172185467500110010010000000111234567819.xml";
    var response = [];
    var claveAcceso;
    $.ajax({
        url: "/facturador",
    ...
    //  alert(respuesta);
        ...
        oReq.onload = function (oEvent) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    'documento': comprobanteFirmado_xml,
                    'nombre': "1905202001172185467500110010010000000111234567819",
                    '_token':$('input[name=_token]').val()
                },
                context: document.body
            }).done(function (respuesta) {
              console.log("respuesta "+respuesta);
                ...
                $.ajax({
                  ...
                  alert(respuestaValidarComprobante);
                    ...
                    if (/RECIBIDA/i.test(respuesta) || /CLAVE ACCESO REGISTRADA/i.test(respuesta)) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                'service': service, 'claveAcceso': $claveAcceso.text(),'empresa':empresa,
                                '_token':$('input[name=_token]').val()
                            },
                            context: document.body
                            ...
                            alert(autorizacion_comprobante);
                        });
                    } else {
                        response[0] = validar_comprobante;
                       alert(response);
...
function fechas_certificado(ruta_certificado, mi_pwd_p12, ruta_respuesta) {
    ...
    oReq.onload = function (oEvent) {
        ...
        $.ajax({
            type: 'POST',
            url: "http://facturacion.bldigitalbusiness.com/src/validarFechaCertificado.php",
            data: {
