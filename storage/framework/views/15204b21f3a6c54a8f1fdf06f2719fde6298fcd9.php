        ...
        <nav class="navbar">
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <span class="brand-big"><?php if($general_setting->site_logo): ?><img src="<?php echo e($general_setting->site_logo); ?>" width="50">&nbsp;&nbsp;<?php endif; ?><h1 class="d-inline"><?php echo e($general_setting->site_title); ?></h1></span>
                ...
                <li class="nav-item">
                      ...
                      <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                          <li class="notifications">
                            <a href="<?php echo e(route('report.qtyAlert')); ?>" class="btn btn-link"> <i class="fa fa-exclamation-triangle"></i> <?php echo e($alert_product); ?> Productos con stock minimo</a>
                          </li>
                      </ul>
                </li>
                <?php endif; ?>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-6 text-right">
              <p><?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <a href="http://bldigitalbusiness.com" class="external">B&L DIGITALBUSINESS</a></p>
            </div>
          </div>
        </div>
      </footer>
...
<?php /**PATH C:\laragon\www\PROYECTO-LAZARO\PUBLICO_GENERAL\nueva-version\resources\views/layout/top-head.blade.php ENDPATH**/ ?>