...
<section>
    <div class="container-fluid">
        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#account-modal"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Account')); ?></button>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="account-table" class="table table-striped table-sm">
            <thead>
                <tr>
