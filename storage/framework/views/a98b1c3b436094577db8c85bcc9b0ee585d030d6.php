...
$('#quotation-form').on('submit',function(e){
    ...
    if (rownumber < 0) {
        swal("Please insert product to order table!")
        e.preventDefault();
    }
});
