...
<section>
    <div class="container-fluid">
        <a href="<?php echo e(route('retencion.create')); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Añadir Retención</a>&nbsp;
    </div>
    <div class="container-fluid">
        <div class="table-responsive">
            <table class="table table-sm table-striped" id="table_retencion">
                ...
                <tbody>
                    <?php $__currentLoopData = $lims_retenciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                        ...
                                        <!--<button type="button" onclick="obtenerComprobanteFirmado_sri(<?php echo e($item->id); ?>,'07');" class="edit-btn btn btn-link"><i class="fa fa-paper-plane"></i> Enviar SRI</button>-->
                                        </li>
                                        <?php endif; ?>
                                        <li class="divider"></li>
                                        <?php if($item->estado_sri=="autorizado"): ?>
                                        <li>
                                          <button type="button" onclick="enviarRideCliente(<?php echo e($item->id); ?>,'07')" class="btn btn-link"><i class="fa fa-paper-plane"></i>Renviar Mail</button>
                                      </li>
                                      <?php endif; ?>
                                      <li>
                                          <button type="submit" class="btn btn-link" onclick="return GenerarPdf(<?php echo e($item->id); ?>,'07')"><i class="fa fa-eye"></i>Generar Descargar PDF</button>
                                      </li>
                                      <li>
                                          <button type="button" onclick="DescargarXml(<?php echo e($item->id); ?>,'07')" class="btn btn-link"><i class="fa fa-download"></i>Descargar Xml</button>
                                      </li>
                                      <?php if($item->estado_sri=="autorizado"): ?>
                                        <li>
...
<script type="text/javascript" src="<?php echo e(asset('facturacion/fiddle.js')); ?>"></script>
