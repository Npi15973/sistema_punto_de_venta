        ...
        <table id="customer-table" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th class="not-exported" ><?php echo e(trans('file.Customer Group')); ?></th>
                    <th><?php echo e(trans('file.name')); ?></th>
                    <th class="not-exported" ><?php echo e(trans('file.Company Name')); ?></th>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li> 
                                    <a href="<?php echo e(route('customer.edit',$customer)); ?>" class="btn btn-link"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                </li>
                                <?php endif; ?>
                                <li>
