...
<section>
    <div class="container-fluid">
      <?php if(in_array("expenses-add", $all_permission)): ?>
        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#expense-modal"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Expense')); ?></button>
      <?php endif; ?>
    </div>
    <hr>
    <div class="table-responsive" style="font-size: 12px;">
        <table id="expense-table" class="table table-striped table-sm">
            <thead>
                <tr>
