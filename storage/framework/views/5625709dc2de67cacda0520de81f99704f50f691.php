...
<section>
    <div class="container-fluid">
        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Holiday')); ?> </button>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="holiday-table" class="table table-striped table-sm">
            <thead>
                <tr>
