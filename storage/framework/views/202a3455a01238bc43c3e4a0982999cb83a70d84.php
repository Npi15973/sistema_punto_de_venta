...
<section>
    <div class="container-fluid">
        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Brand')); ?> </button>&nbsp;
        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#importBrand"><i class="fa fa-file"></i> <?php echo e(trans('file.Import Brand')); ?></button>
    </div>
    <hr>
        ...
        <table id="biller-table" class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($brand->id); ?>">
                    ...
                    <?php if($brand->image): ?>
                    <td> <img src="<?php echo e($brand->image); ?>" height="80" width="80">
                    </td>
                    <?php else: ?>
                    <td>No Image</td>
                    <?php endif; ?>
