...
$documentoModificado = DB::table('tipo_documento_electronico')->where('codigo',$infoNotaCredito->codDocModificado)->first();
        ...
        <div class="d">
            ...
            <div style="border-style: solid; border-width: 1px; padding: 10px; border-radius: 25px;  margin-right: 10px;">
                <table>
                    ...
                    <tr>
                        <td>
                            <strong>Dir Establecimiento:</strong> <?php echo e($infoNotaCredito->dirEstablecimiento); ?>
                    ...
                    <tr>
                        <td>
                            <strong>OBLIGADO CONTABILIDAD:</strong> <?php echo e($infoNotaCredito->obligadoContabilidad); ?>
        ...
        <div class="c" style="border-style: solid; border-width: 1px; padding: 10px;">
            <div class="c">
                <table>
                    <tr>
                        <td>
                            Razón Social / Nombres y Apellidos: <?php echo e($infoNotaCredito->razonSocialComprador); ?>
            ...
            <div class="d" style="margin-top: 10px;">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($infoNotaCredito->identificacionComprador); ?>
           ...
           <div class="c">
                <table>
                    <tr>
                        <td>
                            Comprobante que se modifica  : <?php echo e($documentoModificado->name); ?> - <?php echo e($infoNotaCredito->numDocModificado); ?>

                        </td>
                        <td>
                            Fecha emisión comprobante :  <?php echo e($infoNotaCredito->fechaEmisionDocSustento); ?>

                        </td>
                    </tr>
                    <tr>
                        <td>
                            Razó Modificacion : <?php echo e($infoNotaCredito->motivo); ?>
            ...
            <table style="border: 1px solid black;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo e(bcadd($infoNotaCredito->totalSinImpuestos,'0',2)); ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo e(bcadd($infoNotaCredito->totalDescuento,'0',2)); ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo e(bcadd($infoNotaCredito->valorModificacion,'0',2)); ?>
