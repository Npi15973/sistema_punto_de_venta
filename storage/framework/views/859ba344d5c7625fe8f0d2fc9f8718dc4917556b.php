...
<section>
    <div class="container-fluid">
        <a href="<?php echo e(route('biller.create')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Biller')); ?></a>&nbsp;
    </div>
    <hr>
    <div class="col-lg-12">
        <div class="table-responsive">
            <table id="biller-table" class="table table-striped table-sm">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr data-id="<?php echo e($biller->id); ?>">
                        ...
                        <td><?php echo e($biller->establecimiento); ?></td>
                        <td><?php echo e($biller->codigo); ?></td>
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <a href="<?php echo e(route('biller.edit', $biller->id)); ?>" class="btn btn-link"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                    </li>
                                    <li class="divider"></li>
