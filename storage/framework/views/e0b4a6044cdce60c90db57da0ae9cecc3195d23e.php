...
<section>
    <div class="container-fluid">
        <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Warehouse')); ?></a>
        <a href="#" data-toggle="modal" data-target="#importWarehouse" class="btn btn-primary btn-sm"><i class="fa fa-file"></i> <?php echo e(trans('file.Import Warehouse')); ?></a>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="warehouse-table" class="table table-striped table-sm">
            <thead>
                <tr>
  ...
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.Add Warehouse')); ?> - Establecimiento</h5>
      ...
      <div class="modal-body">
        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
          ...
          <div class="form-group">
            ...
            <select name="emisor_id" id="emisor_id" class="form-control">
              <?php $__currentLoopData = $emisor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($item->id); ?>"><?php echo e($item->nombre_comercial); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
          </div>
          <div class="form-group">
            <label><strong>Codigo *</strong></label>
            <input required class="form-control" name="codigo"/>
          </div>
          <div class="form-group">
            <label><strong>Codigo numérico *</strong></label>
            <input required class="form-control"  name="codigo_numerico"/>
          </div>
          <div class="form-group">
            <label><strong>Codigo referencia *</strong></label>
            <input required class="form-control"  name="cod_ref"/>
          </div>
          <div class="form-group">
	...
	$(document).ready(function() {
	    ...
	    $('.open-EditWarehouseDialog').on('click', function() {
	        ...
	        $.get(url, function(data) {
              ...
              $("input[name='codigo_numerico']").val(data['codigo_numerico']);
              $("input[name='cod_ref']").val(data['cod_ref']);
              $("select[name='emisor_id']").val(data['emisor_id']);
