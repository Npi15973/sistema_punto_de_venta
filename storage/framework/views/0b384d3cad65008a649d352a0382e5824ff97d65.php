...
<section>
    ...
    <div class="container-fluid">
        <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Employee')); ?></a>
    </div>
    <?php endif; ?>
    <hr>
