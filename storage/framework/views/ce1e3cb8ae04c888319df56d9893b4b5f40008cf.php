...
<section>
    <div class="container-fluid">
        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Expense Category')); ?></button>&nbsp;
        <!--<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#importExpenseCategory"><i class="fa fa-file"></i> <?php echo e(trans('file.Import Expense Category')); ?></button>-->
    </div>
    <hr>
