...
<section>
    <div class="container-fluid">
        <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Unit')); ?></a>&nbsp;
        <a href="#" data-toggle="modal" data-target="#importUnit" class="btn btn-primary btn-sm"><i class="fa fa-file"></i> <?php echo e(trans('file.Import Unit')); ?></a>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="unit-table" class="table table-striped table-sm">
            <thead>
                <tr>
