...
<section>
    <div class="container-fluid">
        <?php if(in_array("quotes-add", $all_permission)): ?>
            <a href="<?php echo e(route('quotations.create')); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Quotation')); ?></a>
        <?php endif; ?>
    </div>
    <hr>
    <div class="table-responsive" style="font-size:12px;">
        <table id="quotation-table" class="table table-striped quotation-list table-sm">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                ?>
                <tr class="quotation-link" data-quotation='["<?php echo e(date($general_setting->date_format, strtotime($quotation->created_at->toDateString()))); ?>", "<?php echo e($quotation->reference_no); ?>", "<?php echo e($status); ?>", "<?php echo e($biller->name); ?>", "<?php echo e($customer->name); ?>", "<?php echo e($customer->phone_number); ?>", "<?php echo e($customer->address); ?>", "<?php echo e($customer->city); ?>", "<?php echo e($quotation->id); ?>", "<?php echo e($quotation->total_tax); ?>", "<?php echo e($quotation->total_discount); ?>", "<?php echo e($quotation->total_price); ?>", "<?php echo e($quotation->order_tax); ?>", "<?php echo e($quotation->order_tax_rate); ?>", "<?php echo e($quotation->order_discount); ?>", "<?php echo e($quotation->shipping_cost); ?>", "<?php echo e($quotation->grand_total); ?>", "<?php echo e($quotation->note); ?>", "<?php echo e($user->name); ?>", "<?php echo e($user->email); ?>"]'>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('quotations.edit', $quotation)); ?>"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?></a></button>
                                </li>
                                <?php endif; ?>
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('quotation.create_sale', $quotation)); ?>"><i class="fa fa-shopping-cart"></i> <?php echo e(trans('file.Create Sale')); ?></a></button>
                                </li>
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('quotation.create_purchase',$quotation)); ?>"><i class="fa fa-shopping-basket"></i> <?php echo e(trans('file.Create Purchase')); ?></a></button>
                                </li>
                                <li class="divider"></li>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                <div class="col-md-3">
                    <button id="print-btn" type="button" class="btn btn-default btn-sm d-print-none"><i class="fa fa-print"></i> </button>
                    <?php echo e(Form::open(['route' => 'quotation.sendmail', 'method' => 'post', 'class' => 'sendmail-form'] )); ?>

                        <input type="hidden" name="quotation_id">

                    <button class="btn btn-default btn-sm d-print-none"><i class="fa fa-envelope"></i> </button>
                    <?php echo e(Form::close()); ?>
...
<script type="text/javascript">
    ...
    function quotationDetails(quotation){
        //console.log(quotation);
        //alert(quotation[8]);
        $('input[name="quotation_id"]').val(quotation[8]);
        ...
        $.get('quotations/product_quotation/' + quotation[8], function(data){
            $(".product-quotation-list tbody").remove();
            console.log(quotation[8]);
