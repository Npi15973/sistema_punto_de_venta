...
<section>
    ...
    <div class="container-fluid">
        <?php if(in_array("sales-add", $all_permission)): ?>
            ...
            <a href="<?php echo e(route('sales.create')); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Sale')); ?></a>&nbsp;
            <!--<a href="<?php echo e(url('sales/sale_by_csv')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-file"></i> <?php echo e(trans('file.Import Sale')); ?></a>-->
        <?php endif; ?>
    </div>
    <hr>
    <div class="table-responsive">
        
        <table id="sale-table" class="table table-striped sale-list table-sm" style="width: 100%">
            <thead>
                <tr>
                    <th class="not-exported"></th>
                    <th class="not-exported"><?php echo e(trans('file.action')); ?></th>
                    <th>Fecha Emisión</th>
                    <th class="not-exported">Fecha Autorización</th>
                    <th >Estado factura</th>
                    <th class="not-exported">Clave Acceso</th>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-1">
                            ...
                            <select name="paid_by_id" class="form-control">
                                ...
                                <option value="6">Deposito/Transferecia</option>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript">
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        if(sale_id.length && confirm("¿Estás segura que quieres eliminar??")) {
                            $.ajax({
                                type:'POST',
    ...
    if(all_permission.indexOf("sales-delete") == -1)
        ...
        function confirmDelete() {
            if (confirm("¿Estás segura que quieres eliminar??")) {
                return true;
            }
            return false;
        }
    ...
    function confirmPaymentDelete() {
        if (confirm("¿Estás segura que quieres eliminar?? If you delete this money will be refunded.")) {
            return true;
        }
        return false;
    }
...
/*<script type="text/javascript" src="<?php echo e(asset('facturacion_/forge.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('facturacion_/forge.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('facturacion_/buffer.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('facturacion_/moment.min.js')); ?>"></script>*/

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\PROYECTO-LAZARO\PUBLICO_GENERAL\nueva-version\resources\views/sale/index.blade.php ENDPATH**/ ?>