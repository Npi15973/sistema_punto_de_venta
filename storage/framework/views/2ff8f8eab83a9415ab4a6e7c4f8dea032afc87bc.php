...
<section>
  ...
  <div class="container-fluid">
    ...
    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#createModal"><i
        class="fa fa-plus"></i> <?php echo e(trans("file.Add Category")); ?></button>&nbsp;
    <!--<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#importCategory"><i class="fa fa-file"></i> <?php echo e(trans('file.Import Category')); ?></button>-->

  </div>
  <hr>
  <div class="table-responsive">
    <table id="category-table" class="table table-striped table-sm" style="width: 100%">
      <thead>
        <tr>
      ...
      <div class="modal-body">
        ...
        <form>
          <div class="form-group">
            ...
            <?php echo e(Form::text('name',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type
            category name...'))); ?>

          </div>
          <div class="form-group">
            <label><strong><?php echo e(trans('file.Parent Category')); ?></strong></label>
            <?php echo e(Form::select('parent_id', $lims_categories, null, ['class' => 'form-control','placeholder' => 'No Parent
            Category'])); ?>

          </div>
          <div class="form-group">
            <label><strong>Es Menú</strong></label>
            <select class="form-control" name="as_menu">
              <option value="0">NO</option>
              <option value="1">SI</option>
            </select>
          </div>
          <div class="form-group">
            <label><strong>Mostrar en web:</strong></label>
          ...
          <div class="form-group">
            <label><strong>Mostrar en móvil:</strong></label>
...
<div id="importCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
  ...
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
        <p><?php echo e(trans('file.The correct column order is')); ?> (name*, parent_category) <?php echo e(trans('file.and you must follow
          this')); ?>.</p>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <a href="public/sample_file/sample_category.csv" class="btn btn-info btn-block btn-md"><i
                  class="fa fa-download"></i> <?php echo e(trans('file.Download')); ?></a>
            </div>
          </div>
        </div>
        <input type="submit" value="<?php echo e(trans('file.submit')); ?>" class="btn btn-primary">
  ...
  $("ul#product").siblings('a').attr('aria-expanded','true');
    ...
    $(document).on("click", ".open-EditCategoryDialog", function(){
          ...
          $.get(url, function(data){
            ...
            $("#editModal select[name='as_menu']").val(data['as_menu']);
            $("#editModal select[name='web']").val(data['web']);
            $("#editModal select[name='mobile']").val(data['mobile']);
