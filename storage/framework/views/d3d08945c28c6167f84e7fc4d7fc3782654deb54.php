...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e($general_setting->site_logo); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo asset('css/dropzone.css') ?>"></link>
    <link rel="stylesheet" href="<?php echo asset('css/style.css') ?>"></link>
    ...
    <script type="text/javascript" src="<?php echo asset('vendor/facturacion/buffer.js') ?>"></script>
    <script type="text/javascript" src="<?php echo asset('vendor/facturacion/forge.min.js') ?>"></script>
    <script type="text/javascript" src="<?php echo asset('vendor/facturacion/fiddle.js') ?>"></script>
    <script type="text/javascript" src="<?php echo asset('vendor/facturacion/moment.min.js') ?>"></script>
  ...
  <body style="font-size:12px;" onload="myFunction()">
            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-cart-outline"></i><span><?php echo e(trans('file.Sale')); ?></span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  <?php if($index_permission_active): ?>
                  <li id="sale-list-menu"><a href="<?php echo e(route('sales.index')); ?>">Lista de facturas</a></li>
                  <?php
                  ...
                  <li id="sale-create-menu"><a href="<?php echo e(route('sales.create')); ?>">Añadir Factura</a></li>
              ...
              <!--<li><a href="#facturacion" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-id-card"></i><span>Doc. Electrónicos</span></a>
                <ul id="facturacion" class="collapse list-unstyled ">
                  <li id="nota-credito-create-menu"><a href="<?php echo e(route('nota.credito')); ?>">Nota crédito</a></li>
                  <li id="nota-debito-create-menu"><a href="<?php echo e(route('nota.debito')); ?>">Nota débito</a></li>
                  <li id="guia-create-menu"><a href="<?php echo e(route('guia')); ?>">Guía</a></li>
                  <li id="retencion-create-menu"><a href="<?php echo e(route('retencion')); ?>">Retención</a></li>
                  <li id="liquidacion-create-menu"><a href="<?php echo e(route('liquidacion')); ?>">Liquidación</a></li>
                </ul>
              </li>-->
              <?php
              ...
              <li class=""><a href="#account" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-university"></i><span>CONTABILIDAD</span></a>
              ...
              <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-gear-outline"></i><span><?php echo e(trans('file.settings')); ?></span></a>
                <ul id="setting" class="collapse list-unstyled ">
                 ...
                 <li id="user-menu"><a href="<?php echo e(route('user.profile', ['id' => Auth::id()])); ?>"><?php echo e(trans('file.User Profile')); ?></a></li>
                  ...
                  <?php endif; ?>
                  <?php if($hrm_setting_permission_active): ?>
                  <li id="emisor-setting-menu"><a href="<?php echo e(route('emisor.inicio')); ?>"> Emisor</a></li>
                  <?php endif; ?>
                </ul>
              </li>
            </ul>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li class="nav-item"><a class="dropdown-item" href="<?php echo e(route('sale.pos')); ?>" target="_blank"><i class="fa fa-th-large"></i><span> POS</span></a></li>
                <?php endif; ?>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-6 text-right">
              <p><?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <a href="http://www.bldigitalbusiness.com" class="external">BL DIGITAL BUSINESS</a></p>
            </div>
          </div>
        </div>
      </footer>
...
<?php /**PATH C:\laragon\www\PROYECTO-LAZARO\PUBLICO_GENERAL\nueva-version\resources\views/layout/main.blade.php ENDPATH**/ ?>