                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e($item->nombre_comercial); ?>

                                    </td>
                                    <td>
                                        <?php echo e($item->direccion_matriz); ?>

                                    </td>
                                    <td>
                                        <span  class='<?php echo e($css); ?>'><?php echo e($mensaje); ?></span>
                                    </td>
                                    <td>
                                        <a   href="<?php echo e(route('emisor.edit',['id' => $item->id])); ?>" class="btn btn-defualt">Editar</a>
                                        <button type="button" onclick="Eliminar(<?php echo e($item->id); ?>);" class="btn btn-danger btn-sm">Eliminar</button>
                                    </td>
                                </tr>
...
<section>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <form action="<?php echo e(route('emisor.create')); ?>" enctype="multipart/form-data" method ="POST">
