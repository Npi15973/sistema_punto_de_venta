...
<section>
    <div class="container-fluid">
        <?php if(in_array("products-add", $all_permission)): ?>
            <a href="<?php echo e(route('products.create')); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> <?php echo e(__('file.add_product')); ?></a>
            <a href="#" data-toggle="modal" data-target="#importProduct" class="btn btn-primary btn-sm"><i class="fa fa-file"></i> <?php echo e(__('file.import_product')); ?></a>
        <?php endif; ?>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="product-data-table" class="table table-striped table-sm" style="width: 100%">
            <thead>
                <tr>
...
<div id="product-details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">Detalle</h5>
...
<script>
    ...
    if(product_image1.length >= 1) {
                ...
                for (var i = 0; i < product_image1.length; i++) {
                    
                    if(!i)
                        slidertext += '<div class="carousel-item active"><img src="'+product_image1[i].imagen_base64+'" height="300" width="100%"></div>';
                    else
                        slidertext += '<div class="carousel-item"><img src="'+product_image1[i].imagen_base64+'" height="300" width="100%"></div>';
                }
                ...
                slidertext = '<img src="#" height="300" width="100%">';
    }
