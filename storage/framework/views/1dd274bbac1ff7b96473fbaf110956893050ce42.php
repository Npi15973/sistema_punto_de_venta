...
<section>
    <div class="container-fluid">
        ...
        <a href="<?php echo e(route('supplier.create')); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> <?php echo e(trans('file.Add Supplier')); ?></a>
       
        <?php endif; ?>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="supplier-table" class="table table-striped table-sm">
            <thead>
                <tr>
                    <th class="not-exported"></th>
                    <th class="not-exported"><?php echo e(trans('file.Image')); ?></th>
                    ...
                    <th class="not-exported"><?php echo e(trans('file.Address')); ?></th>
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($supplier->id); ?>">
                    ...
                    <td> <img src="<?php echo e(url('public/images/supplier',$supplier->image)); ?>" height="50" width="50">
                    </td>
                    <?php else: ?>
                    <td>No Image</td>
                    <?php endif; ?>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                	<a href="<?php echo e(route('supplier.edit', $supplier)); ?>" class="btn btn-link"><i class="fa fa-edit"></i> <?php echo e(trans('file.edit')); ?></a>
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
