                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mt-1">
                                        ...
                                        <select name="forma_pago" class="form-control">
                                            <?php $__currentLoopData = $formas_pago; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($item->codigo); ?>"><?php echo e($item->descripcion); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row ml-2">
                        ...
                        <?php if($brand->image): ?>
                            <div class="col-md-3 brand-img" data-brand="<?php echo e($brand->id); ?>">
                                <img  src="<?php echo e($brand->image); ?>" />
                        ...
                        <div class="col-md-12 mt-1 table-container">
                            <table id="product-table" class="table product-list">
                                ...
                                <?php for($i=0; $i < ceil($product_number/5); $i++): ?>
                                    <tr>
                                        <td class="product-img sound-btn" title="<?php echo e($lims_product_list[0+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[0+$i*5]->code . ' (' . $lims_product_list[0+$i*5]->name . ')'); ?>"><img  src="<?php echo e($lims_product_list[0+$i*5]->base_image); ?>" width="100%" />
                                            <p><?php echo e($lims_product_list[0+$i*5]->name); ?></p>
                                        </td>
                                        <?php if(!empty($lims_product_list[1+$i*5])): ?>
                                        <td class="product-img sound-btn" title="<?php echo e($lims_product_list[1+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[1+$i*5]->code . ' (' . $lims_product_list[1+$i*5]->name . ')'); ?>"><img  src="<?php echo e($lims_product_list[1+$i*5]->base_image); ?>" width="100%" />
                                        ...
                                        <td class="product-img sound-btn" title="<?php echo e($lims_product_list[2+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[2+$i*5]->code . ' (' . $lims_product_list[2+$i*5]->name . ')'); ?>"><img  src="<?php echo e($lims_product_list[2+$i*5]->base_image); ?>" width="100%" />
                                        ...
                                        <td class="product-img sound-btn" title="<?php echo e($lims_product_list[3+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[3+$i*5]->code . ' (' . $lims_product_list[3+$i*5]->name . ')'); ?>"><img  src="<?php echo e($lims_product_list[3+$i*5]->base_image); ?>" width="100%" />
                                        ...
                                        <td class="product-img sound-btn" title="<?php echo e($lims_product_list[4+$i*5]->name); ?>" data-product ="<?php echo e($lims_product_list[4+$i*5]->code . ' (' . $lims_product_list[4+$i*5]->name . ')'); ?>"><img  src="<?php echo e($lims_product_list[4+$i*5]->base_image); ?>" width="100%" />
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="<?php echo e(route('sales.edit', $sale)); ?>" class="btn btn-success btn-sm" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;
                                                        <?php endif; ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        <?php if(session()->has('error_formato_doc')): ?>
        swal({
            title: "Error!",
        ...
        <?php endif; ?>
        <?php if(session()->has('error_cantidad_consumidor')): ?>
    swal({
        title: "Error!",
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\PROYECTO-LAZARO\PUBLICO_GENERAL\nueva-version\resources\views/sale/pos.blade.php ENDPATH**/ ?>