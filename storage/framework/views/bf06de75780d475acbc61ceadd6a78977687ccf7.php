        ...
        <div class="d">
            ...
            <div style="border-style: solid; border-width: 1px; padding: 10px; border-radius: 25px;  margin-right: 10px;">
                <table>
                    ...
                    <tr>
                        <td>
                            <strong>Dir Establecimiento:</strong> <?php echo e($infoFactura->dirEstablecimiento); ?>
                    ...
                    <tr>
                        <td>
                            <strong>OBLIGADO CONTABILIDAD:</strong> <?php echo e($infoFactura->obligadoContabilidad); ?>
        ...
        <div class="d">
            <div style="border-style: solid; border-width: 1px; padding: 10px; border-radius: 25px;">
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            EMISIÓN: <?php if($infoTributaria->tipoEmision=="1") echo "NORMAL"; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <div class="c" style="border-style: solid; border-width: 1px; padding: 10px;">
            <div class="c">
                <table>
                    <tr>
                        <td>
                            Razón Social / Nombres y Apellidos: <?php echo e($infoFactura->razonSocialComprador); ?>
            ...
            <div class="d" style="margin-top: 10px;">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($infoFactura->identificacionComprador); ?>
            ...
            <div style="padding-top: 10px;">
                <table style="border: 1px solid black;width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($infoAdicional->address); ?>
           ...
           <div style="padding-top: 10px;">
            ...
            <table style="border: 1px solid black;width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo e(bcadd($pago->total,'0',2)); ?>
            ...
            <table style="border: 1px solid black;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo e(bcadd($infoFactura->totalSinImpuestos,'0',2)); ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo e(bcadd($infoFactura->totalDescuento,'0',2)); ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php echo e(bcadd($infoFactura->importeTotal,'0',2)); ?>
...
</html><?php /**PATH C:\laragon\www\PROYECTO-LAZARO\PUBLICO_GENERAL\nueva-version\resources\views/ride/factura.blade.php ENDPATH**/ ?>