                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" value="<?php echo e($lims_product_data->code); ?>" class="form-control" required>
