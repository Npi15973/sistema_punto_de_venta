   ...
   */
   ...
   /**
    ...
    public function validarCedula($numero = '')
    {
        ...
        // validaciones
        try {
            if($this->validarInicial($numero, '10') && $this->validarCodigoProvincia(substr($numero, 0, 2)) && $this->validarTercerDigito($numero[2], 'cedula') && $this->algoritmoModulo10(substr($numero, 0, 9), $numero[9])){
                return true;
            }
            return false;
        } catch (Exception $e) {
    ...
    public function validarRucPersonaNatural($numero = '')
    {
        ...
        // validaciones
        try {
            if($this->validarInicial($numero, '13') && $this->validarCodigoProvincia(substr($numero, 0, 2)) && $this->validarTercerDigito($numero[2], 'ruc_natural') && $this->validarCodigoEstablecimiento(substr($numero, 10, 3)) && $this->algoritmoModulo10(substr($numero, 0, 9), $numero[9])){
                return true;
            }    
            return false;
        } catch (Exception $e) {
