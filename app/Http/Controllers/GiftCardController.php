...
class GiftCardController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('unit')) {
            ...
            return view('gift_card.index', compact('lims_customer_list', 'lims_user_list',
            'lims_gift_card_all'));
        }
        else
    ...
    public function store(Request $request)
    {
        ...
        if($data['user_id']){
            ...
            try{
                ...
                $message = 'Tarjeta de regalo creada con éxito. Configura tu<a href="setting/mail_setting">mail</a> para enviar correos.';
            }
        }
        else{
    ...
    public function recharge(Request $request, $id)
    {
        ...
        if($lims_customer_data->email){
            ...
            try{
                ...
                {
                    $message->to( $data['email'] )->subject( 'Información de recarga de GiftCard' );
                });
            }
            catch(\Exception $e){
                $message = 'Tarjeta de regalo recargada con éxito. Configura tu <a href="setting/mail_setting">mail </a> para enviar correos.';
            }
        }
        return redirect('gift_cards')->with('message', $message);
    }
    ...
    public function deleteBySelection(Request $request)
    {
        ...
        return 'Tarjeta de regalo eliminada correctamente!';
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_gift_card_data->is_active = false;
        $lims_gift_card_data->save();
        return redirect('gift_cards')->with('not_permitted', 'Datos eliminados exitosamente');
    }
