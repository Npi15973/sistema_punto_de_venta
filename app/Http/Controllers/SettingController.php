...
class SettingController extends Controller
{
    public function emptyDatabase()
    {
        ...
        foreach ($tables as $table) {
            if($table->$str != 'accounts' && $table->$str != 'general_settings' && $table->$str != 'hrm_settings' && $table->$str != 'languages' && $table->$str != 'migrations' && $table->$str != 'password_resets'
            && $table->$str != 'permissions' && $table->$str != 'pos_setting' && $table->$str != 'roles'
            && $table->$str != 'role_has_permissions' && $table->$str != 'users') {
    ...
    public function generalSetting()
    {
        ...
        return view('setting.general_setting', compact('lims_general_setting_data',
        'lims_account_list', 'zones_array'));
    }
    ...
    public function generalSettingStore(Request $request)
    {
        ...
        $this->validate($request, [
            'site_logo' => 'image|mimes:jpg,jpeg,png,gif|max:3000000',
        ]);
        ...
        $general_setting->theme= $data['theme_platform'];
        ...
        if ($logo) {
            ...
            $general_setting->site_logo = $imagen_base64;
    ...
    public function posSetting()
    {
    	...
    	return view('setting.pos_setting', compact('lims_customer_list', 'lims_warehouse_list',
      'lims_biller_list', 'lims_pos_setting_data'));
    }
    ...
    public function posSettingStore(Request $request)
    {
      ...
      if(PosSetting::first()){
        $pos_setting = PosSetting::first();
      	...
      	$pos_setting->stripe_public_key = "No app";
      	$pos_setting->stripe_secret_key = "No app";
      ...
      return redirect()->back()->with('message', 'Configuración de POS guardado con éxito');
    }
