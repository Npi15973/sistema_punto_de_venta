...
class DeliveryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($lims_customer_data->email && $data['status'] != 1){
            ...
            try{
                ...
                $message = 'Entrega creada con éxito. Configura tu <a href="setting/mail_setting">mail </a> para enviar correos.';
            }
        }
    ...
    public function update(Request $request)
    {
        ...
        if($lims_customer_data->email && $input['status'] != 1){
            ...
            try{
                ...
                $message = 'Entrega actualizada con éxito. Configura tu<a href="setting/mail_setting">mail</a> para enviar correos.';
            }
        }
    	return redirect('delivery')->with('message', $message);
    }
    ...
    public function deleteBySelection(Request $request)
    {
        ...
        return 'Entrega eliminada con éxito';
    }
    ...
    public function delete($id)
    {
    	$lims_delivery_data = Delivery::find($id);
    	$lims_delivery_data->delete();
    	return redirect('delivery')->with('not_permitted', 'Entrega eliminada con éxito');
    }
