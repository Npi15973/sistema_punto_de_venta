...
class StockCountController extends Controller
{
    public function index()
    {
        ...
        if( $role->hasPermissionTo('stock_count') ) {
            ...
            return view('stock_count.index', compact('lims_warehouse_list', 'lims_brand_list',
             'lims_category_list', 'lims_stock_count_all'));
        }
        else
        ...
        if( isset($data['brand_id']) && isset($data['category_id']) ){
            ...
            ->where([ ['products.is_active', true],
             ['product_warehouse.warehouse_id', $data['warehouse_id']],
              ...
              ])->select('products.name', 'products.code', 'product_warehouse.qty')->get();
