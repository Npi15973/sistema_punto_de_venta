...
class ReturnController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $message = 'Retorno creado con éxito';
        if($mail_data['email']){
            try{
                ...
                $message = 'Retorno creado con éxito. Configura tu <a href="setting/mail_setting">mail</a> para enviar correos.';
            }
        }
    ...
    public function sendMail(Request $request)
    {
        ...
        if($lims_customer_data->email) {
            ...
            $message = 'La cliente no tiene correo electrónico!';
    ...
    public function edit($id)
    {
        ...
        if($role->hasPermissionTo('returns-edit')){
            ...
            return view('return.edit',compact('lims_customer_list', 'lims_warehouse_list',
             'lims_biller_list', 'lims_tax_list', 'lims_return_data','lims_product_return_data'));
        }
        else
            return redirect()->back()->with('not_permitted', '¡Lo siento! No tienes permiso para acceder a este módulo');
    }
    ...
    public function deleteBySelection(Request $request)
    {
        ...
        return '¡Devolución eliminada con éxito!';
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_return_data->delete();
        return redirect('return-sale')->with('not_permitted', 'Datos eliminados exitosamente');;
    }
