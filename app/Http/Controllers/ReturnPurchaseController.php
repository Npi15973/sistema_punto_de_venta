...
class ReturnPurchaseController extends Controller
{
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('purchase-return-add')){
            ...
            return view('return_purchase.create', compact('lims_warehouse_list',
            'lims_supplier_list', 'lims_tax_list', 'lims_account_list'));
        }
        else
            return redirect()->back()->with('not_permitted', '¡Lo siento! No tienes permiso para acceder a este módulo');
    }
    ...
    public function edit($id)
    {
        ...
        if($role->hasPermissionTo('purchase-return-edit')){
            ...
            return view('return_purchase.edit',compact('lims_supplier_list', 'lims_warehouse_list',
             'lims_tax_list', 'lims_account_list', 'lims_return_data','lims_product_return_data'));
        }
        else
            return redirect()->back()->with('not_permitted', '¡Lo siento! No tienes permiso para acceder a este módulo');;
    }
