...
class CategoryController extends Controller
{
  ...
  /*GUARDAR CATEGORIAS*/
    public function categoryData(Request $request)
    {
        ...
        if(!empty($categories))
        {
            foreach ($categories as $key=>$category)
            {
                ...
                $nestedData['as_menu'] = $category->as_menu;
                $nestedData['web'] = $category->web;
                $nestedData['mobile'] = $category->mobile;
    ...
    public function store(Request $request)
    {
        ...
        $lims_category_data['as_menu'] = $request->as_menu;
        $lims_category_data['web'] =$request->web;
        $lims_category_data['mobile'] = $request->mobile;
