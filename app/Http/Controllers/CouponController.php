...
class CouponController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Coupon::create($data);
        return redirect('coupons')->with('message', 'Cupón creado con éxito');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('coupons')->with('message', 'Cupón actualizado con éxito');
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_coupon_data->is_active = false;
        $lims_coupon_data->save();
        return redirect('coupons')->with('not_permitted', 'Cupón eliminado con éxito');
    }
