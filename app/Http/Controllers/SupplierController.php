...
class SupplierController extends Controller
{
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('suppliers-add')){
            ...
            return view('supplier.create',compact('tipo_documento'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function edit($id)
    {
        ...
        if($role->hasPermissionTo('suppliers-edit')){
            ...
            return view('supplier.edit',compact('lims_supplier_data','tipo_documento'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
    ...
    public function importSupplier(Request $request)
    {
        ...
        while($columns=fgetcsv($file))
        {
           ...
           $supplier->save();
           $message = 'Proveedor importado correctamente';
           if($data['email']){
                try{
                    Mail::send( 'mail.supplier_create', $data, function( $message ) use ($data)
                    {
                      ...
                      $message = 'Proveedor importado correctamente. Please setup your <a href="setting/mail_setting">mail setting</a> to send mail.';
                }
            }
        }
        return redirect('supplier')->with('message', $message);
