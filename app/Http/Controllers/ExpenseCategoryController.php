...
class ExpenseCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('expense_categories')->with('message', 'Datos insertados con éxito');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('expense_categories')->with('message', 'Datos actualizados exitosamente');
    }
    ...
    public function import(Request $request)
    {
        ...
        if($ext != 'csv')
            return redirect()->back()->with('not_permitted', 'Sube un archivo CSV');
