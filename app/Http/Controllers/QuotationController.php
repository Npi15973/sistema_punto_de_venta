...
class QuotationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($lims_quotation_data->quotation_status == 2 && $mail_data['email']){
           /* try{
                ...
                $message = 'Presupuesto creado con éxito. Configura tu <a href="setting/mail_setting">mail </a> para enviar correos.';
            }*/
        }
    ...
    public function sendMail(Request $request)
    {
        ...
        if($lims_customer_data->email) {
           ...
           try{
                Mail::send( 'mail.quotation_details', $mail_data, function( $message ) use ($mail_data)
                {
                    $message->to( $mail_data['email'] )->subject( 'Detalle de  cotización' );
                });
                $message = 'Correo enviado correctamente';
            }
            catch(\Exception $e){
                $message = 'Configura tu<a href="setting/mail_setting">mail </a> para enviar correos.';
            }
        }
        else
            $message = 'Cliente no tiene email valido!';
    ...
    public function update(Request $request, $id)
    {
        ...
        if($lims_quotation_data->quotation_status == 2 && $mail_data['email']){
            /*try{
                ...
                $message = 'Presupuesto actualizado con éxito. Configura tu <a href="setting/mail_setting">mail</a> para enviar correos';
            }*/
        }
        return redirect('quotations')->with('message', $message);
    }
    ...
    public function createSale($id)
    {
        ...
        return view('quotation.create_sale',compact('lims_customer_list','formas_pago', 'lims_warehouse_list', 'lims_biller_list', 'lims_tax_list', 'lims_quotation_data','lims_product_quotation_data', 'lims_pos_setting_data'));
    }
    ...
    public function destroy($id)
    {
        ...
        $lims_quotation_data->delete();
        return redirect('quotations')->with('not_permitted', 'Cotización eliminada correctamente');
    }
