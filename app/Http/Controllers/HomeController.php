...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        while($start < $end)
        {
            $start_date = new DateTime(date("Y").'-'.date('m', $start).'-'.'01');
            $end_date = new DateTime(date("Y").'-'.date('m', $start).'-'.'31');
            ...
            $month[] = date("F", strtotime($start_date->format('Y-m-d')));
        ...
        return view('index', compact('revenue', 'purchase', 'expense', 'return', 'purchase_return', 'profit', 'payment_recieved', 'payment_sent', 'month', 'yearly_sale_amount', 'yearly_purchase_amount', 'recent_sale', 'recent_purchase', 'recent_quotation',
         'recent_payment', 'best_selling_qty', 'yearly_best_selling_qty',
         'yearly_best_selling_price'));
    ...
    public function myTransaction($year, $month)
    {
        ...
        return view('user.my_transaction', compact('start_day', 'year', 'month', 'number_of_day', 'prev_year',
        'prev_month', 'next_year', 'next_month', 'sale_generated', 'sale_grand_total',
        'purchase_generated', 'purchase_grand_total','quotation_generated',
