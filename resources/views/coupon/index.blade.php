...
<section>
    <div class="container-fluid">
        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#create-modal"><i class="fa fa-plus"></i> {{trans('file.Add Coupon')}}</button>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="coupon-table" class="table table-striped table-sm">
            <thead>
                <tr>
