                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="liquidacion">Generar liquidación de compra?</label>
                                    <select name="liquidacion_compra" id="liquidacion_compra" class="form-control">
                                        <option value="">Seleccione si desea generar liquidacion de compra</option>
