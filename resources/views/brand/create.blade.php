...
<section>
    <div class="container-fluid">
        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i> {{trans('file.Add Brand')}} </button>&nbsp;
        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#importBrand"><i class="fa fa-file"></i> {{trans('file.Import Brand')}}</button>
    </div>
    <hr>
        ...
        <table id="biller-table" class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <tr data-id="{{$brand->id}}">
                    <td>{{$key}}</td>
                    @if($brand->image)
                    <td> <img src="{{$brand->image}}" height="80" width="80">
                    </td>
                    @else
                    <td>No Image</td>
                    @endif
