...
<section>
    <div class="container-fluid">
        @if(in_array("purchase-return-add", $all_permission))
            <a href="{{route('return-purchase.create')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> {{trans('file.Add Return')}} de compra</a>
        @endif
    </div>
    <div class="table-responsive">
        <table id="return-table" class="table table-striped return-list table-sm">
            <thead>
                <tr>
