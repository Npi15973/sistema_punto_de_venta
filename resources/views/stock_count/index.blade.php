...
<section>
    <div class="container-fluid">
        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i> {{trans('file.Count Stock')}} </button>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="stock-count-table" class="table table-striped stock-count-list table-sm">
            <thead>
                <tr>
