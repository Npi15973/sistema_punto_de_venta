        ...
        <div class="d">
            ...
            <div style="border-style: solid; border-width: 1px; padding: 10px; border-radius: 25px;  margin-right: 10px;">
                <table>
                    ...
                    <tr>
                        <td>
                            <strong>Dir Establecimiento:</strong> {{$infoFactura->dirEstablecimiento}}
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <strong>OBLIGADO CONTABILIDAD:</strong> {{$infoFactura->obligadoContabilidad}}
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div class="d">
            <div style="border-style: solid; border-width: 1px; padding: 10px; border-radius: 25px;">
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            EMISIÓN: @php if($infoTributaria->tipoEmision=="1") echo "NORMAL"; @endphp
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <div class="c" style="border-style: solid; border-width: 1px; padding: 10px;">
            <div class="c">
                <table>
                    <tr>
                        <td>
                            Razón Social / Nombres y Apellidos: {{$infoFactura->razonSocialComprador}}
                        </td>                       
                    </tr>
                </table>
            </div>
            ...
            <table style="border: 1px solid black;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{bcadd($infoFactura->totalSinImpuestos,'0',2)}}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        {{bcadd($infoFactura->totalDescuento,'0',2)}}
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{bcadd($infoFactura->importeTotal,'0',2)}}
                    </td>
                </tr>
            </table>
        </div>
