        ...
        <div class="d">
            ...
            <div style="border-style: solid; border-width: 1px; padding: 10px; border-radius: 25px;  margin-right: 10px;">
                <table>
                    ...
                    <tr>
                        <td>
                            <strong>Dir Establecimiento:</strong> {{$infoNotaCredito->dirEstablecimiento}}
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <strong>OBLIGADO CONTABILIDAD:</strong> {{$infoNotaCredito->obligadoContabilidad}}
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div class="c" style="border-style: solid; border-width: 1px; padding: 10px;">
            <div class="c">
                <table>
                    <tr>
                        <td>
                            Razón Social / Nombres y Apellidos: {{$infoNotaCredito->razonSocialComprador}}
                        </td>                       
                    </tr>
                </table>
            </div>
           ...
           <div class="c">
                <table>
                    <tr>
                        <td>
                            Comprobante que se modifica  : {{$documentoModificado->name}} - {{$infoNotaCredito->numDocModificado}}
                        </td>
                        <td>
                            Fecha emisión comprobante :  {{$infoNotaCredito->fechaEmisionDocSustento}}
                        </td>
                    </tr>
                    <tr>
                        <td>
                            Razó Modificacion : {{$infoNotaCredito->motivo}}
                        </td>
                    </tr>
                </table>
           </div>
            ...
            <table style="border: 1px solid black;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{bcadd($infoNotaCredito->totalSinImpuestos,'0',2)}}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        {{bcadd($infoNotaCredito->totalDescuento,'0',2)}}
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{bcadd($infoNotaCredito->valorModificacion,'0',2)}}
                    </td>
                </tr>
            </table>
        </div>
