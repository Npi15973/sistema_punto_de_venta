...
<section>
    <div class="container-fluid">
        ...
        <a href="{{route('supplier.create')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> {{trans('file.Add Supplier')}}</a>
        ...
        <table id="supplier-table" class="table table-striped table-sm">
            <thead>
                <tr>
                    ...
                    <th class="not-exported">{{trans('file.Address')}}</th>
            ...
            <tbody>
                ...
                <tr data-id="{{$supplier->id}}">
                    <td>{{$key}}</td>
                    @if($supplier->image)
                    <td> <img src="{{url('public/images/supplier',$supplier->image)}}" height="50" width="50">
                    </td>
                    @else
                    <td>No Image</td>
                    @endif
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                	<a href="{{ route('supplier.edit', $supplier) }}" class="btn btn-link"><i class="fa fa-edit"></i> {{trans('file.edit')}}</a>
                                </li>
                                @endif
                                <li class="divider"></li>
