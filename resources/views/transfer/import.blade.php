                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <a href="../public/sample_file/sample_transfer_products.csv" class="btn btn-primary btn-block btn-md"><i class="fa fa-download"></i> {{trans('file.Download Sample File')}}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
