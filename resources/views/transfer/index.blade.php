...
<section>
    <div class="container-fluid">
        @if(in_array("transfers-add", $all_permission))
            <a href="{{route('transfers.create')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> {{trans('file.add')}} {{trans('file.Transfer')}}</a>
            <a href="{{url('transfers/transfer_by_csv')}}" class="btn btn-primary btn-sm"><i class="fa fa-file"></i> {{trans('file.import')}} {{trans('file.Transfer')}}</a>
        @endif
    </div>
    <hr>
    <div class="table-responsive">
        <table id="transfer-table" class="table table-striped transfer-list table-sm">
            <thead>
                <tr>
