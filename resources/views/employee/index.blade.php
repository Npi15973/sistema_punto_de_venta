...
<section>
    ...
    <div class="container-fluid">
        <a href="{{route('employees.create')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> {{trans('file.Add Employee')}}</a>
    </div>
    @endif
    <hr>
    <div class="table-responsive">
        <table id="employee-table" class="table table-striped table-sm">
            <thead>
                <tr>
