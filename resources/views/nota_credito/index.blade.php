...
<section>
    <div class="container-fluid">
        <a href="{{route('nota.credito.create')}}"  type="submit" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Añadir Nota de Crédito</a>&nbsp;
    </div>
    <div class="container-fluid">
        <div class="table-responsive">
            <table class="table table-sm table-striped" id="table_nota_credito">
                ...
                <tbody>
                    @foreach ($lims_nota_credito as $item)
                        <tr>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                        ...
                                        <!--<button type="button" onclick="obtenerComprobanteFirmado_sri({{$item->id}},'04');" class="edit-btn btn btn-link"><i class="fa fa-paper-plane"></i>
                                        Enviar SRI</button>-->
                                        </li>
                                        @endif
                                        <li class="divider"></li>
                                        ...
                                        <li>
                                            <button type="button" onclick="enviarRideCliente({{$item->id}},'04')" class="btn btn-link"><i class="fa fa-paper-plane"></i>Renviar Mail</button>
                                        </li>
                                        @endif
                                        <li>
                                            <button type="submit" class="btn btn-link" onclick="return GenerarPdf({{$item->id}},'04')"><i class="fa fa-eye"></i>Generar Descargar PDF</button>
                                        </li>
                                        <li>
                                            <button type="button" onclick="DescargarXml({{$item->id}},'04')" class="btn btn-link"><i class="fa fa-download"></i>Descargar Xml</button>
                                        </li>
                                        @if($item->estado_sri=="autorizado")
                                        <li>
