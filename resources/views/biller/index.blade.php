...
<section>
    <div class="container-fluid">
        <a href="{{route('biller.create')}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> {{trans('file.Add Biller')}}</a>&nbsp;
    </div>
    <hr>
    <div class="col-lg-12">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <a href="{{ route('biller.edit', $biller->id) }}" class="btn btn-link"><i class="fa fa-edit"></i> {{trans('file.edit')}}</a>
                                    </li>
                                    <li class="divider"></li>
