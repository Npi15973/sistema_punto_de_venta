                        ...
                        {!! Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']) !!}
                            <div class="row">
                              ...
                              <!--  <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>{{trans('file.theme1 Tema')}} *</strong></label>
                                        <select name="theme_platform" class="selectpicker form-control">
                                            <option value="default.css"> {{trans('file.default default')}}</option>
                                            <option value="green.css"> {{trans('file.green green')}}</option>
                                            <option value="blue.css"> {{trans('file.blue blue')}}</option>
                                            <option value="dark.css"> {{trans('file.dark dark')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
