        ...
        <table id="customer-table" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th class="not-exported" >{{trans('file.Customer Group')}}</th>
                    <th>{{trans('file.name')}}</th>
                    <th class="not-exported" >{{trans('file.Company Name')}}</th>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li> 
                                    <a href="{{ route('customer.edit',$customer) }}" class="btn btn-link"><i class="fa fa-edit"></i> {{trans('file.edit')}}</a>
                                </li>
                                @endif
                                <li>
