...
<section>
    <div class="container-fluid">
        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#gift_card-modal"><i class="fa fa-plus"></i> {{trans('file.Add Gift Card')}}</button>
    </div>
    <div class="table-responsive">
        <table id="gift_card-table" class="table table-striped table-sm">
            <thead>
                <tr>
