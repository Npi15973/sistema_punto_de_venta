...
<section>
    <div class="container-fluid">
        @if(in_array("products-add", $all_permission))
            <a href="{{route('products.create')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> {{__('file.add_product')}}</a>
            <a href="#" data-toggle="modal" data-target="#importProduct" class="btn btn-primary btn-sm"><i class="fa fa-file"></i> {{__('file.import_product')}}</a>
        @endif
    </div>
    <hr>
