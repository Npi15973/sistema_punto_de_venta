...
<section>
  ...
  <div class="container-fluid">
    ...
    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#createModal"><i
        class="fa fa-plus"></i> {{trans("file.Add Category")}}</button>&nbsp;
    <!--<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#importCategory"><i class="fa fa-file"></i> {{trans('file.Import Category')}}</button>-->
      ...
      <div class="modal-body">
        ...
        <form>
          <div class="form-group">
            ...
            {{Form::text('name',null,array('required' => 'required', 'class' => 'form-control', 'placeholder' => 'Type
            category name...'))}}
          </div>
          <div class="form-group">
            <label><strong>{{trans('file.Parent Category')}}</strong></label>
            {{Form::select('parent_id', $lims_categories, null, ['class' => 'form-control','placeholder' => 'No Parent
            Category'])}}
          </div>
          <div class="form-group">
...
<div id="importCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
  ...
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
        <p>{{trans('file.The correct column order is')}} (name*, parent_category) {{trans('file.and you must follow
          this')}}.</p>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
