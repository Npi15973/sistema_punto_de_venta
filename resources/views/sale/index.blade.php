...
<section>
    ...
    <div class="container-fluid">
        @if(in_array("sales-add", $all_permission))
            ...
            <a href="{{route('sales.create')}}" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> {{trans('file.Add Sale')}}</a>&nbsp;
            <!--<a href="{{url('sales/sale_by_csv')}}" class="btn btn-primary btn-sm"><i class="fa fa-file"></i> {{trans('file.Import Sale')}}</a>-->
        @endif
    </div>
    <hr>
...
/*<script type="text/javascript" src="{{asset('facturacion_/forge.js')}}"></script>
<script type="text/javascript" src="{{asset('facturacion_/forge.min.js')}}"></script>
<script type="text/javascript" src="{{asset('facturacion_/buffer.js')}}"></script>
<script type="text/javascript" src="{{asset('facturacion_/moment.min.js')}}"></script>*/
