...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="{{$general_setting->site_logo}}" />
            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-cart-outline"></i><span>{{trans('file.Sale')}}</span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  @if($index_permission_active)
                  <li id="sale-list-menu"><a href="{{route('sales.index')}}">Lista de facturas</a></li>
                  <?php
                  ...
                  <li id="sale-create-menu"><a href="{{route('sales.create')}}">Añadir Factura</a></li>
              ...
              <!--<li><a href="#facturacion" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-id-card"></i><span>Doc. Electrónicos</span></a>
                <ul id="facturacion" class="collapse list-unstyled ">
                  <li id="nota-credito-create-menu"><a href="{{route('nota.credito')}}">Nota crédito</a></li>
                  <li id="nota-debito-create-menu"><a href="{{route('nota.debito')}}">Nota débito</a></li>
                  <li id="guia-create-menu"><a href="{{route('guia')}}">Guía</a></li>
                  <li id="retencion-create-menu"><a href="{{route('retencion')}}">Retención</a></li>
                  <li id="liquidacion-create-menu"><a href="{{route('liquidacion')}}">Liquidación</a></li>
                </ul>
              </li>-->
              <?php
              ...
              <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-gear-outline"></i><span>{{trans('file.settings')}}</span></a>
                <ul id="setting" class="collapse list-unstyled ">
                 ...
                 <li id="user-menu"><a href="{{route('user.profile', ['id' => Auth::id()])}}">{{trans('file.User Profile')}}</a></li>
                  ...
                  @endif
                  @if($hrm_setting_permission_active)
                  <li id="emisor-setting-menu"><a href="{{route('emisor.inicio')}}"> Emisor</a></li>
                  @endif
                </ul>
              </li>
            </ul>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                ?>
                @if($add_permission_active)
                <li class="nav-item"><a class="dropdown-item" href="{{route('sale.pos')}}" target="_blank"><i class="fa fa-th-large"></i><span> POS</span></a></li>
                @endif
                @if($alert_product > 0)
                <li class="nav-item">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-6 text-right">
              <p>{{trans('file.Developed')}} {{trans('file.By')}} <a href="http://www.bldigitalbusiness.com" class="external">BL DIGITAL BUSINESS</a></p>
            </div>
          </div>
        </div>
      </footer>
