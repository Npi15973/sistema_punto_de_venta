        ...
        <nav class="navbar">
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <span class="brand-big">@if($general_setting->site_logo)<img src="{{$general_setting->site_logo}}" width="50">&nbsp;&nbsp;@endif<h1 class="d-inline">{{$general_setting->site_title}}</h1></span>
                ...
                <li class="nav-item">
                      ...
                      <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                          <li class="notifications">
                            <a href="{{route('report.qtyAlert')}}" class="btn btn-link"> <i class="fa fa-exclamation-triangle"></i> {{$alert_product}} Productos con stock minimo</a>
                          </li>
                      </ul>
                </li>
                @endif
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-6 text-right">
              <p>{{trans('file.Developed')}} {{trans('file.By')}} <a href="http://bldigitalbusiness.com" class="external">B&L DIGITALBUSINESS</a></p>
            </div>
          </div>
        </div>
      </footer>
